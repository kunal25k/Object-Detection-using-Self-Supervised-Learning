...
def get_model(num_classes):
    model = torchvision.models.detection.fasterrcnn_resnet18_fpn(pretrained=False)
...
def main():
    ...
    valid_dataset = UnlabeledDataset(root='labeled/', transform=get_transform_unlabeled(train=False))
    ...
    for epoch in range(num_epochs):
        ...
        final_arr = return_boundingbox(model, valid_loader, device= device)
    return final_arr
    print("That's it!")
